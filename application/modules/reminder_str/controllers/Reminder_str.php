...
class Reminder_str extends MY_Controller {
	...
	{
		parent::__construct();
		$this->data['title'] = 'STR Reminder';
		$this->data['subtitle'] = '';
		$this->data['module'] = 'reminder_str';
	...
	public function index()
	{
		...
		foreach($result as $r){
			$this->table->add_row(
				...
				$i++,
				anchor(site_url('bidan/str/index/'.$r->bidan_id),$r->bidan_name),
