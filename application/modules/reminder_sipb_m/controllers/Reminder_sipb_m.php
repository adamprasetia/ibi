...
class Reminder_sipb_m extends MY_Controller {
	...
	{
		parent::__construct();
		$this->data['title'] = 'SIPB-M Reminder';
		$this->data['subtitle'] = '';
		$this->data['module'] = 'reminder_sipb_m';
	...
	public function index()
	{
		...
		foreach($result as $r){
			$this->table->add_row(
				...
				$i++,
				anchor(site_url('bidan/sipb_m/index/'.$r->bidan_id),$r->bidan_name),
