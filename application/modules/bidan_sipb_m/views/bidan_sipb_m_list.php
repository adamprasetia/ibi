...
<div class="box box-default">
	...
	<div class="box-header">
		...
		<div class="form-group">
			<?php echo form_dropdown('tipe',$this->general_model->dropdown('bidan_'.$modulesub.'_tipe','Jenis Pengajuan'),$this->input->get('tipe'),'class="form-control input-sm" onchange="submit()"')?>
		</div>
		<div class="form-group">
