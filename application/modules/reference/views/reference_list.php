<div class="box box-default">
	<div class="box-body">
		<a href="<?php echo site_url($url.'/add'.get_query_string()) ?>" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-plus"></span> Tambah</a>			
	</div>
</div>
<?php echo $this->session->flashdata('alert')?>
<div class="box box-default">
	<div class="box-header">
		<form action="<?php echo site_url($url.'/search'.get_query_string(null,'offset')) ?>" method="post" class="form-inline">
	...
	<div class="box-body">
		<form action="<?php echo site_url($url.'/delete'.get_query_string()) ?>" method="post" class="form-check-delete">
