	...
	<div class="box-body">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group form-inline">
					<label for="tlp" class="control-label">No Telp/Hp</label>
					: <span id="tlp"></span>
				</div>
				<div class="form-group form-inline">
				...
				<div class="form-group form-inline">
					<label for="kampus" class="control-label">Nama Institusi</label>
					: <span id="kampus"></span>
				</div>
				<div class="form-group form-inline">
					<label for="tahun_lulus" class="control-label">Tahun Lulusan</label>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group form-inline">
					<label for="praktik_name" class="control-label">Nama Tempat</label>
					: <span id="praktik_name"></span>
				</div>
				<div class="form-group form-inline">
					<label for="praktik_add" class="control-label">Alamat</label>
					: <span id="praktik_add"></span>
				</div>
			</div>
		</div>
		<div class="panel panel-default">
	...
	function gen_bidan(){
		$.ajax({
			...
			success:function(str){
				...
				$('#praktik_name').html(str.praktik_name);
				$('#praktik_add').html(str.praktik_add);
			}
		});
	}
</script>