...
class Reminder_sipb_p_model extends CI_Model {

	private $tbl_name = 'bidan_sipb_p';
	...
	private function query()
	{
		...
		$data[] = $this->db->where('a.masa_berlaku <>','0000-00-00');
		$data[] = $this->db->where('a.masa_berlaku <= DATE_ADD(\''.date('Y-m-d').'\',INTERVAL 2 MONTH)');
