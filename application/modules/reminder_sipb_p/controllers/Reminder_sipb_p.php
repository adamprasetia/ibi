...
class Reminder_sipb_p extends MY_Controller {
	...
	{
		parent::__construct();
		$this->data['title'] = 'SIPB-P Reminder';
		$this->data['subtitle'] = '';
		$this->data['module'] = 'reminder_sipb_p';
	...
	public function index()
	{
		...
		foreach($result as $r){
			$this->table->add_row(
				...
				$i++,
				anchor(site_url('bidan/sipb_p/index/'.$r->bidan_id),$r->bidan_name),
				'<span class="badge '.reminder_badge($r->masa_berlaku).'">'.dateformatindo($r->masa_berlaku,2).'</span>'
			);
		}
