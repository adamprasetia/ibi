...
<div class="box box-default">
	<form action="<?php echo site_url($module.'/search'.get_query_string(null,'offset')) ?>" class="form-inline" method="post">
		<div class="box-header">
			...
			<div class="form-group">
				<?php echo form_dropdown('jenis',$this->general_model->dropdown('keuangan_jenis','Jenis'),$this->input->get('jenis'),'class="form-control input-sm" onchange="submit()"')?>
			</div>
			<div class="form-group">
				<?php echo form_dropdown('wilayah',$this->general_model->dropdown('wilayah','Wilayah'),$this->input->get('wilayah'),'class="form-control input-sm" onchange="submit()"')?>
			</div>
